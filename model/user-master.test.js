...
describe('UserMaster', () => {
  ...
  describe('contructor', () => {
    it('should instantiate UserMaster', () => {
      assert.isArray(
        userMaster.users,
        'userMaster.users should be instantiated as an array'
      )
    })
  })
  describe('create', () => {
    it('should return a User', () => {
      ...
      assert.deepEqual(
        result.name,
        name,
        'parameter name should be passed along to User'
      )
      assert.deepEqual(
        isStrWithLength(result.id),
        true,
        'should generate id for User'
      )
    })
    ...
    it('should add user to users list', () => {
      ...
      assert.deepEqual(
        userMaster.users.length > users.length,
        true,
        'should add user to users list'
      )
    })
